...
jdbcURL = "jdbc:sqlserver://tt-sql-dw-2.database.windows.net:1433;database=AdWrks2;user=tt-sql-dw-2@tt-sql-dw-2;password={CORRECT-horse-battery-staple};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;"
...
exampleTwoDF = spark.read.jdbc(
  url=jdbcURL,                  # the JDBC URL
  table=tableName,              # the name of the table
  column="productkey",                  # the name of a column of an integral type that will be used for partitioning.
  lowerBound=1,                 # the minimum value of columnName used to decide partition stride.
  upperBound=606,            # the maximum value of columnName used to decide partition stride
