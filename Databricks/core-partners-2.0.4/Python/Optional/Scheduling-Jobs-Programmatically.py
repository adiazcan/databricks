...
# MAGIC %md
# MAGIC # Scheduling Jobs Programmatically
# MAGIC 
...
# MAGIC **A:** <a href="https://docs.azuredatabricks.net/user-guide/dev-tools/databricks-cli.html#set-up-the-cli" target="_blank">Databricks documentation for step-by-step instructions.</a>
# MAGIC 
# MAGIC **Q:** How can I do a `spark-submit` job using the API?
# MAGIC **A:** <a href="https://docs.azuredatabricks.net/api/latest/examples.html#spark-submit-api-example" target="_blank">Databricks documentation for API examples.</a>
