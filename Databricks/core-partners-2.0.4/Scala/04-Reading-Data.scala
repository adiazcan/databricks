...
val CSV_FILE = "dbfs:/mnt/training/initech/products/adventureworks.csv"

val tempDF = spark.read.csv(CSV_FILE)
...
val csvSchema = StructType(
  ...
  StructField("ModifiedDate", StringType) :: Nil)
...
val OUTPUT_FILE = s"$userhome/adventureworks/Products.parquet"
...
s"$userhome/adventureworks/Products.parquet"
