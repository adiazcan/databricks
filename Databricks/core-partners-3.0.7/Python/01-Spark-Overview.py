...
# MAGIC %md
# MAGIC # Introduction to Databricks & Apache Spark
# MAGIC 
# MAGIC ## Learning Objectives
# MAGIC By the end of this lesson, you should be able to: 
# MAGIC * Describe the components of the Databricks platform 
# MAGIC * Describe the advantages of Databricks vs Open-Source Spark 
# MAGIC * List the languages that can be used working with Spark/Databricks
# MAGIC * Define a Resilient Distributed Dataset (RDD)
# MAGIC * Discuss the architecture of a cluster
...
# MAGIC 
# MAGIC - Databricks was founded in 2013 by the creators of Apache Spark, Delta Lake, and MLflow. 
# MAGIC - Around 1300 employees based out of downtown San Francisco. 
# MAGIC - In October 2019, we raised $400M in our Series F on a $6.2B valuation. 
# MAGIC - Over 5000 global companies use our platform across their big data & machine learning lifecycle.

# COMMAND ----------

# MAGIC %md
# MAGIC ## <img src="https://files.training.databricks.com/images/databricks-logo.png" width=30px> Unified Data Analytics Platform
# MAGIC 
# MAGIC One cloud platform for massive scale data engineering and collaborative data science
# MAGIC 
# MAGIC <img src=https://files.training.databricks.com/images/adbcore/marketecture-azure.png width=600px>

# COMMAND ----------

# MAGIC %md
# MAGIC ### <img src="https://files.training.databricks.com/images/databricks-logo.png" width=30px> Data Science Workspace
# MAGIC **Collaboration across the full data and machine learning lifecycle**
# MAGIC - [Collaborative Notebooks](https://databricks.com/product/collaborative-notebooks)
# MAGIC - [ML Runtime](https://databricks.com/product/machine-learning-runtime)
# MAGIC - [MLflow](https://databricks.com/product/managed-mlflow)

# COMMAND ----------

# MAGIC %md
# MAGIC ### <img src="https://files.training.databricks.com/images/databricks-logo.png" width=30px> Unified Data Service
# MAGIC **High quality data with great performance**
# MAGIC - [Delta Lake](https://databricks.com/product/delta-lake-on-databricks)
# MAGIC - [Databricks Runtime](https://databricks.com/product/databricks-runtime)
# MAGIC - BI Reporting with SparkSQL

# COMMAND ----------

# MAGIC %md
# MAGIC ##<img src="https://files.training.databricks.com/images/databricks-logo.png" width=30px> Enterprise Cloud Service
# MAGIC 
# MAGIC **A simple, scalable, and secure managed service**
# MAGIC - [Enterprise Security](https://databricks.com/databricks-enterprise-security)
# MAGIC - Simple Adminstration
# MAGIC - [Production Ready](https://databricks.com/product/enterprise-cloud-service)
# MAGIC 
