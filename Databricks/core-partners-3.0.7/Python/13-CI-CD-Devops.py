...
# MAGIC * Define Continuous Integration and Continuous Delivery 
# MAGIC * Configure a notebook with Azure DevOps
# MAGIC * Automatically deploy into a production workspace using Azure DevOps
# MAGIC 
...
# MAGIC - [Continuous Integration & Continuous Delivery with Databricks](https://databricks.com/blog/2017/10/30/continuous-integration-continuous-delivery-databricks.html)
# MAGIC - [Azure DevOps Services Version Control](https://docs.microsoft.com/en-us/azure/databricks/notebooks/azure-devops-services-version-control)
# MAGIC - [GitHub Version Control](https://docs.microsoft.com/en-us/azure/databricks/notebooks/github-version-control)
# MAGIC - [Creating Continuous Integration Pipelines on Azure Using Azure Databricks and Azure DevOps](https://databricks.com/session/devops-for-applications-in-azure-databricks-creating-continuous-integration-pipelines-on-azure-using-azure-databricks-and-azure-devops)
