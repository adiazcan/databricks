...
storageAccount = dbutils.secrets.get(scope="students", key="storageaccount")
containerName = "polybase"
accessKey = dbutils.secrets.get(scope="instructor", key="storagekey")
...
jdbcURI = dbutils.secrets.get(scope="instructor", key="jdbc")
