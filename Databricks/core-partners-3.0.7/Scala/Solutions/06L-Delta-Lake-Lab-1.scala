...
// MAGIC 
// MAGIC Your business intelligence team wants to create a dashboard to track the total number of orders made by customers globally. Many of your customers are international retailers, and have the same customer ID.
// MAGIC 
...
val customerCounts = deltaDF.groupBy("CustomerID", "Country")
  .count()
...
val newCustomerCounts = newDataDF
